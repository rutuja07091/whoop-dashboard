...
Live dashboard — full churn-risk ranking, volume-vs-intent quadrant, trends over time, platform split, revenue exposure by team, and sourced complaint evidence, all in one view.

Live Amplitude dashboard (public link, no login needed) — the same real, category-tagged review data queried directly out of Amplitude.
